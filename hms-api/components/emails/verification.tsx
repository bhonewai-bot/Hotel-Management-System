          ...
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:480px;background-color:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 8px 30px rgba(30,27,75,0.1);">
            ...
            <tr>
              <td style="padding:40px 40px 8px;">
                <h2 style="margin:0;color:#1e1b4b;font-size:20px;font-weight:700;">Verify your email</h2>
                <p style="margin:12px 0 0;color:#475569;font-size:15px;line-height:1.6;">We received a request to verify the email address <strong style="color:#1e1b4b;">${email}</strong>. Click the button below to verify your email address.</p>
              </td>
            </tr>
            <tr>
              <td style="padding:28px 40px 8px;" align="center">
                <a href="${url}" style="display:inline-block;background-color:#4338ca;color:#ffffff;font-size:15px;font-weight:600;text-decoration:none;padding:14px 32px;border-radius:10px;">Verify Email Address</a>
              </td>
            </tr>
            <tr>
