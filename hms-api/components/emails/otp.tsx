          ...
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:480px;background-color:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 8px 30px rgba(27,37,69,0.08);">
            ...
            <tr>
              <td style="padding:40px 40px 8px;">
                ...
                <p style="margin:12px 0 0;color:#5b6577;font-size:15px;line-height:1.6;">Use the verification code below to finish signing in to the admin dashboard. This code expires in <strong style="color:#1b2545;">${expiryMinutes} minutes</strong>.</p>
              </td>
            </tr>
            <tr>
