          ...
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:480px;background-color:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 8px 30px rgba(27,37,69,0.08);">
            ...
            <tr>
              <td style="padding:40px 40px 8px;">
                ...
                <p style="margin:12px 0 0;color:#5b6577;font-size:15px;line-height:1.6;">We received a request to reset the password for the email address <strong style="color:#1b2545;">${email}</strong>. Click the button below to reset your password.</p>
              </td>
            </tr>
            <tr>
              <td style="padding:28px 40px 8px;" align="center">
                <a href="${url}" style="display:inline-block;background-color:#1b2545;color:#ffffff;font-size:15px;font-weight:600;text-decoration:none;padding:14px 32px;border-radius:10px;">Reset Password</a>
              </td>
            </tr>
            <tr>
