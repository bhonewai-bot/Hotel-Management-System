...
export function renderResetPasswordEmail({ url, email }: ResetPasswordEmailProps) {
  return `<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
    ...
    <title>Reset your password - HMS Hotel</title>
  </head>
  <body style="margin:0;padding:0;background-color:#f0eef8;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;">
    <div style="display:none;max-height:0;overflow:hidden;opacity:0;">Reset your password for HMS Hotel</div>
          ...
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:480px;background-color:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 8px 30px rgba(30,27,75,0.1);">
            ...
            <tr>
              <td style="padding:40px 40px 8px;">
                <h2 style="margin:0;color:#1e1b4b;font-size:20px;font-weight:700;">Reset your password</h2>
                <p style="margin:12px 0 0;color:#475569;font-size:15px;line-height:1.6;">We received a request to reset the password for the email address <strong style="color:#1e1b4b;">${email}</strong>. Click the button below to reset your password.</p>
              </td>
            </tr>
            <tr>
              <td style="padding:28px 40px 8px;" align="center">
                <a href="${url}" style="display:inline-block;background-color:#4338ca;color:#ffffff;font-size:15px;font-weight:600;text-decoration:none;padding:14px 32px;border-radius:10px;">Reset Password</a>
              </td>
            </tr>
            <tr>
              <td style="padding:24px 40px 8px;">
                <p style="margin:0;color:#475569;font-size:14px;line-height:1.6;">If the button doesn't work, copy and paste this link into your browser:</p>
                <p style="margin:8px 0 0;color:#1e1b4b;font-size:13px;word-break:break-all;"><a href="${url}" style="color:#4338ca;">${url}</a></p>
              </td>
            </tr>
            <tr>
              <td style="padding:24px 40px 8px;">
                <div style="background-color:#f5f3ff;border:1px solid #ede9fe;border-radius:10px;padding:14px 16px;color:#475569;font-size:13px;line-height:1.6;">
                  Didn't request a password reset? You can safely ignore this email &mdash; your password will remain unchanged.
                </div>
              </td>
            </tr>
            <tr>
