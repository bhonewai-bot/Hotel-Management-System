...
import { ShieldCheck, Lock, ArrowLeft, EnvelopeSimple } from "@phosphor-icons/react";
      ...
      <div className="relative hidden w-[45%] flex-col justify-between overflow-hidden bg-[#1e1b4b] p-10 lg:flex xl:p-14">
        ...
        <div className="relative z-10 max-w-md">
          ...
          <p className="mt-6 max-w-sm text-sm leading-relaxed text-white/50">
            No worries — we&apos;ll send you a reset link to get you back into
            the dashboard.
          </p>
        </div>
        ...
        <div className="w-full max-w-[380px]">
          ...
          {submitted ? (
            <>
              ...
              <Link href="/login">
                <Button variant="outline" className="h-11 w-full text-sm font-medium">
